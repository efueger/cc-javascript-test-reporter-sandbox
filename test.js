window.EagerSegment = {
  ...
  init: function(options) {
	...
	window.analytics.methods = ['identify', 'group', 'track', 'page', 'pageview', 'alias', 'debug', 'ready', 'on', 'once', 'off', 'trackLink', 'trackForm', 'trackClick', 'trackSubmit'];
	...
	// enable the debugger if the option was set.
	if (options.debug) {
